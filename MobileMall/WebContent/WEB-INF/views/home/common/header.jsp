...
<body>
	...
	<div class="shop_hd">
		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p>您好，欢迎来到<b><a href="/MobileMall">手机专卖商城</a></b>
						<c:if test="${account == null }">
						<a href="../home/login">登录</a><a href="../home/register">注册</a><a href="../system/login" target="_blank">登录后台</a>
						</c:if>
						<c:if test="${account != null }">
						[${account.name }]
						</c:if>
		...
		<div class="shop_hd_header">
			<div class="shop_hd_header_logo"><h1 class="logo"><a href="/MobileMall"><img src="../resources/home/images/logo.png" alt="ShopCZ" /></a><span></span></h1></div>
			<div class="shop_hd_header_search">
                            <ul class="shop_hd_header_search_tab">
			        <li id="search" class="current">手机商品专卖店</li>
			    ...
			    <div class="search_form">
			    	<form method="post" action="../product/search">
			    		<div class="search_formstyle">
			    			<input type="text" class="search_form_text" name="search_content" placeholder="618活动等你来拿！抗疫勇士享受五折优惠！" value="${search_content }" />
		...
		<div class="shop_hd_menu">
			...
			<ul class="shop_hd_menu_nav">
				<li class="${currentHome }link"><a href="/MobileMall"><span>首页</span></a></li>
